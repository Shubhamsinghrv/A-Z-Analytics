...
if __name__ == "__main__":
    parquet_gcs_path = "gs://intelli-ana-bucket/df.parquet"
    df = load_parquet_from_gcs(parquet_gcs_path)
    ...
    output_path = "gs://intelli-ana-bucket/scaled-data.parquet"
